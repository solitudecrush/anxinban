...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.sim_reader.SimReaderPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin sim_reader, com.example.sim_reader.SimReaderPlugin", e);
    }
    try {
